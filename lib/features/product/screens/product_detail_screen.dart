    ...
    return Scaffold(
      ...
      body: productAsync.when(
        ...
        data: (data) {
          ...
          final rating =
              item['rating'] ??
              5.0; // Fallback since rating isn't a direct DB column
          final tags = [
            'Handmade',
                  ...
                  background: Stack(
                    ...
                    children: [
                      PageView.builder(
                        ...
                        itemCount: (item['imageUrls'] as List<dynamic>).length,
                      ...
                      Positioned(
                        ...
                        child: Row(
                          ...
                          children: List.generate(
                            (item['imageUrls'] as List<dynamic>).length,
  ...
  List<Widget> _buildReviewsSection(List<dynamic> reviews) {
    ...
    return reviews.map((r) {
      ...
      final username = email
          .toString()
          .split('@')
          .first; // Clean up email for display
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: Theme.of(context).scaffoldBackgroundColor.withOpacity(
          0.95,
        ), // Slight transparency for backdrop effect
            ...
            child: ElevatedButton(
              onPressed: item == null
                  ...
                  : () {
                      context.push(
                        '/booking/${item['id']}',
                      ); // Routing as defined in React specs
                    },
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(
                  0xFF8C2D19,
                ), // Terracotta Red / Primary
